...
export function isOverlapping<T extends PositionInfo, P extends PositionInfo>(o1: T, o2: P): boolean {
...
export function getDegBetweenPoints(o1: [number, number], o2: [number, number]): number {
