...
## How to run locally
This codebase contains both the frontend and backend code. You'll need Node 22. The backend uses NodeJS and must be run before running the frontend. Use the following command to build and start the backend server:
