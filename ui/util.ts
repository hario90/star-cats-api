...
export function cleanUpResources<T extends Drawable>(
    id: string,
    objects: Map<string, T>,
    sectionToObjects: Map<string, Set<T>>
) {
...
export function getSectionsMap<T extends GameObject>(
    positionInfo: T
): Map<string, Section> {
